...
if gemini_api_key and serper_api_key:
    ...
    gemini = LLM(model="gemini/gemini-1.5-flash", temperature=0.7, api_key=gemini_api_key)
    ...
    executive_brief_task = Task(
        ...
        expected_output="A comprehensive executive brief including summary, key talking points, Q&A preparation, and strategic recommendations, formatted in markdown."
    )
    ...
    st.warning("Please enter your Gemini and Serper API keys in the sidebar before proceeding.")
